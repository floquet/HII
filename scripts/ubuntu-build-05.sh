...
# docker run -it  -v /Users/dantopa/repos-xiuhcoatl:/repos ubuntu:25.04
...
# cp /dantopa/repos-xiuhcoatl/github/hii/scripts/generate-ssh-keys.sh .
...
PACKAGES=(
    ...
    lsb-release     # Linux Standard Base core support
